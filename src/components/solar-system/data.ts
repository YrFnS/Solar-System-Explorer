  ...
  },
  {
    ...
    moons: [
      ...
      },
      {
        ...
        orbitRadius: 2.6,
        orbitSpeed: 10.0,
        color: '#F0F0F8', // Bright water ice - frost surface
        diameter: 3122,
        distanceFromPlanet: 671.1,
        orbitalPeriod: 3.55,
        funFact: 'Europa may have a subsurface ocean that could harbor life beneath its icy shell',
      },
      {
        name: 'Ganymede',
        radius: 0.18,
      ...
      },
      {
        ...
        color: '#909090',
        diameter: 98,
        distanceFromPlanet: 222.0,
        orbitalPeriod: 0.67,
        funFact: 'Thebe is a small irregular moon of Jupiter, shaped like an asteroid',
      },
      {
        name: 'Metis',
        radius: 0.01,
        ...
        color: '#A0A0A0',
        diameter: 43,
        distanceFromPlanet: 128.0,
        orbitalPeriod: 0.29,
        funFact: 'Metis is the innermost moon of Jupiter and whips around the planet at incredible speed',
      },
      {
        name: 'Adrastea',
        radius: 0.008,
        ...
        color: '#909090',
        diameter: 26,
        distanceFromPlanet: 129.0,
        orbitalPeriod: 0.30,
        funFact: 'Adrastea is one of the smallest moons in the solar system',
      },
      {
        name: 'Pasiphae',
        radius: 0.02,
        ...
        color: '#808080',
        diameter: 58,
        distanceFromPlanet: 23624.0,
        orbitalPeriod: -743,
        funFact: 'Pasiphae orbits Jupiter in the opposite direction — it is a retrograde moon',
      },
    ],
  },
  {
    ...
    moons: [
      ...
      },
      {
        ...
        color: '#D8D8D8',
        diameter: 1062,
        distanceFromPlanet: 294.6,
        orbitalPeriod: 1.88,
        funFact: 'Tethys is mostly made of water ice and has a giant canyon called Ithaca Chasma',
      },
      {
        name: 'Mimas',
        radius: 0.06,
      ...
      },
      {
        ...
        color: '#D0D0D0',
        diameter: 28,
        distanceFromPlanet: 133.6,
        orbitalPeriod: 0.57,
        funFact: 'Pan is a tiny moon that lives in the Encke Gap of Saturn\'s rings',
      },
      {
        name: 'Daphnis',
        radius: 0.005,
        ...
        color: '#C8C8C8',
        diameter: 9,
        distanceFromPlanet: 136.5,
        orbitalPeriod: 0.59,
        funFact: 'Daphnis creates waves in the ring edges as it orbits',
      },
      {
        name: 'Prometheus',
        radius: 0.015,
        ...
        color: '#B8B0A0',
        diameter: 86,
        distanceFromPlanet: 139.4,
        orbitalPeriod: 0.61,
        funFact: 'Prometheus is a shepherd moon that helps define Saturn\'s F ring',
      },
      {
        name: 'Pandora',
        radius: 0.012,
        ...
        color: '#C0B8A8',
        diameter: 81,
        distanceFromPlanet: 141.7,
        orbitalPeriod: 0.62,
        funFact: 'Pandora is the outer shepherd moon of Saturn\'s F ring',
      },
      {
        name: 'Iapetus',
        radius: 0.11,
        ...
        color: '#A0A090',
        diameter: 1470,
        distanceFromPlanet: 3561.3,
        orbitalPeriod: 79.3,
        funFact: 'Iapetus has one bright hemisphere and one dark hemisphere — the Cassini Regio',
      },
      {
        name: 'Phoebe',
        radius: 0.02,
        ...
        color: '#707070',
        diameter: 213,
        distanceFromPlanet: 12944.0,
        orbitalPeriod: -550,
        funFact: 'Phoebe orbits Saturn in reverse direction and may be a captured asteroid',
      },
    ],
  },
  {
    ...
    moons: [
      ...
      },
      {
        ...
        color: '#D0C8C0',
        diameter: 1158,
        distanceFromPlanet: 191.0,
        orbitalPeriod: 2.52,
        funFact: 'Ariel has the brightest surface of all Uranus moons and shows evidence of recent geological activity',
      },
      {
        name: 'Umbriel',
        radius: 0.08,
        ...
        color: '#A09888',
        diameter: 1169,
        distanceFromPlanet: 266.0,
        orbitalPeriod: 4.14,
        funFact: 'Umbriel is the darkest of Uranus large moons, named after a spirit of melancholy',
      },
      {
        name: 'Miranda',
        radius: 0.06,
  ...
  },
  {
    ...
    moons: [
      ...
      },
      {
        ...
        color: '#888888',
        diameter: 420,
        distanceFromPlanet: 117.6,
        orbitalPeriod: 1.12,
        funFact: 'Proteus is the largest inner moon of Neptune, shaped like an irregular polyhedron',
      },
      {
        name: 'Nereid',
        radius: 0.02,
        ...
        color: '#B0B0B0',
        diameter: 340,
        distanceFromPlanet: 5513.4,
        orbitalPeriod: 360.14,
        funFact: 'Nereid has one of the most eccentric orbits of any moon, swinging from close to far from Neptune',
      },
    ],
  },
]
...
export const humanArtifacts: HumanArtifactData[] = [
  ...
  },
  {
    ...
    size: 0.015,
    color: '#888888',
    funFact: 'Starlink is a constellation of thousands of satellites providing global internet coverage',
    launchYear: 2019,
    distance: '550 km above Earth (LEO)',
  },
  {
    id: 'starlink2',
    name: 'Starlink Satellite',
    ...
    size: 0.015,
    color: '#888888',
    funFact: 'Starlink satellites use Hall-effect thrusters for propulsion and orbit maintenance',
    launchYear: 2019,
    distance: '550 km above Earth (LEO)',
  },
  {
    ...
    size: 0.015,
    color: '#888888',
    funFact: 'Each Starlink satellite weighs about 260kg and has a compact, flat-panel design',
    launchYear: 2019,
    distance: '550 km above Earth (LEO)',
  },
  {
    ...
    size: 0.025,
    color: '#4488AA',
    funFact: 'GPS Block IIF satellites orbit at 20,200 km altitude and provide positioning to millions worldwide',
    launchYear: 2014,
    distance: '20,200 km above Earth (MEO)',
  },
  {
    id: 'tiangong',
    ...
    size: 0.05,
    color: '#CCAAAA',
    funFact: 'Tiangong is China\'s permanent space station, modularly assembled in orbit since 2022',
    launchYear: 2021,
  ...
  },
  {
    ...
    size: 0.035,
    color: '#AA8844',
    funFact: 'Chandra observes X-rays from hot regions of the universe like exploded stars and black holes',
    launchYear: 1999,
    distance: '10,000 km to 130,000 km elliptical orbit',
  },
  {
    id: 'kepler',
    ...
    size: 0.04,
    color: '#AABBCC',
    funFact: 'Kepler discovered over 2,600 exoplanets by detecting dips in starlight as planets transit',
    launchYear: 2009,
    distance: 'Earth-trailing solar orbit (~72 AU from Earth)',
  },
  {
    id: 'voyager1',
    name: 'Voyager 1',
    ...
    modelUrl: '/models/voyager_nasa.glb',
  },
  {
    id: 'voyager2',
    name: 'Voyager 2',
  ...
  },
  {
    ...
    size: 0.0005,
    color: '#DAA520',
    funFact: 'JWST peers into the universe with its 6.5m gold-coated mirror, seeing the earliest galaxies from the L2 point',
    launchYear: 2021,
  ...
  },
  {
    ...
    size: 0.03,
    color: '#A0522D',
    funFact: 'Pioneer 10 was the first spacecraft to travel through the asteroid belt and to fly past Jupiter',
    launchYear: 1972,
    distance: 'Over 27 billion km from Earth',
  },
  {
    id: 'pioneer11',
    name: 'Pioneer 11',
    ...
    size: 0.03,
    color: '#A0522D',
    funFact: 'Pioneer 11 was the first spacecraft to fly past Saturn and explore the outer solar system',
    launchYear: 1973,
    distance: 'Over 23 billion km from Earth',
  },
  {
    id: 'perseverance',
    name: 'Perseverance',
    ...
    size: 0.02,
    color: '#8B4513',
    funFact: 'Perseverance is searching for signs of ancient microbial life and collecting samples for return to Earth',
    launchYear: 2020,
    distance: 'On Mars surface in Jezero Crater',
  },
  {
    id: 'curiosity',
    name: 'Curiosity',
    ...
    size: 0.02,
    color: '#A0522D',
    funFact: 'Curiosity has been exploring Gale Crater on Mars since 2012, studying the planet\'s climate and geology',
    launchYear: 2012,
    distance: 'On Mars surface in Gale Crater',
  },
  {
    id: 'artemis',
    name: 'Artemis I',
    ...
    size: 0.03,
    color: '#E8E8E8',
    funFact: 'Artemis I was an uncrewed test flight that sent Orion around the Moon, paving the way for human return',
    launchYear: 2022,
    distance: 'Orbiting the Moon',
  },
  {
    id: 'europa-clipper',
    name: 'Europa Clipper',
    ...
    size: 0.04,
    color: '#A0B0C0',
    funFact: 'Europa Clipper will study Europa\'s ice shell and subsurface ocean to assess habitability',
    launchYear: 2024,
    distance: 'Orbiting Jupiter/Europa',
  },
  {
    id: 'juice',
    name: 'JUICE',
    ...
    size: 0.04,
    color: '#8090A0',
    funFact: 'JUICE (Jupiter Icy Moons Explorer) will study Ganymede, Callisto, and Europa',
    launchYear: 2023,
    distance: 'En route to Jupiter system',
  },
]

export const ASTEROID_BELT_INNER = 12
export const ASTEROID_BELT_OUTER = 15
export const ASTEROID_COUNT = 12000

export const KUIPER_BELT_INNER = 46
export const KUIPER_BELT_OUTER = 55
export const KUIPER_COUNT = 20000
...
export interface DwarfPlanetData {
  ...
  funFacts: string[]
  textureUrl?: string
  moons?: MoonData[] // for Pluto-Charon binary system
}
...
export const dwarfPlanets: DwarfPlanetData[] = [
    ...
    moons: [
      {
        ...
        color: '#A0A0A0',
        diameter: 1212,
        distanceFromPlanet: 19570,
        orbitalPeriod: 6.387,
        funFact: 'Charon is so large relative to Pluto that they orbit each other like a binary system',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    rotationSpeed: 0.5,
    color: '#888888',
    orbitInclination: 3.3,
    initialAngle: 2.50,
    diameter: 340,
    distanceFromSun: 137.8,
    orbitalPeriod: 323,
    funFacts: [
      'Apophis is a peanut-shaped asteroid that will make a close approach to Earth in 2029',
      'It was originally designated 2004 MN4 and was briefly considered a threat',
      'Apophis is named after the ancient Egyptian god of chaos',
  ...
  },
  {
    ...
    initialAngle: 5.30,
    diameter: 490,
    distanceFromSun: 168.5,
    orbitalPeriod: 436,
    funFacts: [
      'Bennu is a carbonaceous asteroid with a rough, carbon-rich surface',
      'NASA\'s OSIRIS-REx mission collected a sample from Bennu in 2020',
      'Bennu has a 1-in-2,700 chance of impacting Earth in the year 2182',
      'It is a primitive remnant from the early solar system',
    ],
  },
  {
    id: 'orcus',
  ...
  },
  {
    ...
    rotationSpeed: 0.06,
    color: '#808080',
    orbitInclination: 23.9,
    initialAngle: 3.70,
    diameter: 846,
    distanceFromSun: 6325,
    orbitalPeriod: 100078,
    funFacts: [
      'Salacia is a large Kuiper Belt object with a surface covered in ice',
      'It has one known moon named Actaea',
      'Salacia is named after the Roman goddess of the ocean',
      'It is one of the largest known objects in the Kuiper Belt',
    ],
  },
]
