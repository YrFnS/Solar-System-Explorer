...
const DeviceAcceptanceResults = dynamic(
  () => import('../../../../components/solar-system/device-acceptance/DeviceAcceptanceResults'),
  {
    ssr: false,
    loading: () => (
      <main className="grid min-h-screen place-items-center bg-[#02030a] px-4 text-white">
        <div className="rounded-3xl border border-white/10 bg-white/[0.035] px-6 py-5 text-center shadow-2xl backdrop-blur-xl">
          ...
          <p className="mt-2 text-sm text-white/55">
            Preparing the device matrix and merge-readiness analyzer…
          </p>
        </div>
      </main>
    ),
...
export default function DeviceAcceptanceResultsPage() {
  return <DeviceAcceptanceResults />
}
